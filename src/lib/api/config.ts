...
export const API_ENDPOINTS = {
  ...
  AUTH: {
    ...
    EMAIL_PREFLIGHT: '/auth/email/preflight',
  ...
  CONTACT_MESSAGES: {
    ...
    SHOW: (id: number | string) => `/dashboard/contact-messages/${id}`,
    MARK_READ: (id: number | string) => `/dashboard/contact-messages/${id}/read`,
    DELETE: (id: number | string) => `/dashboard/contact-messages/${id}`,
  },
  ...
  SETTINGS: {
    ...
    EMAIL_VERIFICATION_USERS: '/dashboard/settings/email-verification/users',
    EMAIL_VERIFICATION_STATS: '/dashboard/settings/email-verification/stats',
    EMAIL_VERIFICATION_SEND_REMINDERS: '/dashboard/settings/email-verification/send-reminders',
    EMAIL_VERIFICATION_MARK_INVALID: '/dashboard/settings/email-verification/mark-invalid',
    EMAIL_VERIFICATION_CLEAR_STATUS: '/dashboard/settings/email-verification/clear-status',
    EMAIL_VERIFICATION_DELETE_USERS: '/dashboard/settings/email-verification/delete-users',
    EMAIL_VERIFICATION_DELETE_FILTERED: '/dashboard/settings/email-verification/delete-filtered',
    EMAIL_BOUNCE_EVENTS: '/dashboard/settings/email-bounce/events',
    EMAIL_BOUNCE_STATS: '/dashboard/settings/email-bounce/stats',
    EMAIL_BOUNCE_MARK: '/dashboard/settings/email-bounce/mark',
    EMAIL_BOUNCE_RESET: '/dashboard/settings/email-bounce/reset',
    EMAIL_BOUNCE_PROCESS_NOW: '/dashboard/settings/email-bounce/process-now',
  },
  ...
  CONTENT_AUDIT: {
    ...
    ADSENSE_READINESS: '/dashboard/content-audit/adsense-readiness',
    AI_BATCH_JOBS: '/dashboard/content-audit/ai/batch-jobs',
    AI_BATCH_JOB: (id: number | string) => `/dashboard/content-audit/ai/batch-jobs/${encodeURIComponent(String(id))}`,
    AI_BATCH_JOB_CANCEL: (id: number | string) => `/dashboard/content-audit/ai/batch-jobs/${encodeURIComponent(String(id))}/cancel`,
    AI_REVIEW_QUEUE: '/dashboard/content-audit/ai/review-queue',
    AI_MODEL_COSTS: '/dashboard/content-audit/ai/model-costs',
