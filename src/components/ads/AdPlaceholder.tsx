...
export default function AdPlaceholder({ slotId, className = '', label = 'إعلان' }: Props) {
  ...
  return (
    <div className={`w-full bg-slate-50 border-2 border-dashed border-slate-300 rounded-lg flex flex-col items-center justify-center text-slate-600 p-4 my-6 ${className}`}>
