...
export default function ResponsiveAd({
  ...
  if (isDesktop === null) {
    return (
      <div
        className={`ad-wrapper relative rounded-2xl border border-slate-200 bg-white p-4 ${className}`}
        role="complementary"
  ...
  return (
    <div
      ...
      aria-label="Advertisement"
    >
      <span className="ad-label block text-xs text-slate-600 mb-2 text-center font-bold select-none">إعلان</span>
      <div className="min-h-[100px]">
