...
export default function Header() {
  ...
  return (
    <header className="dashboard-topbar sticky top-0 z-30 w-full h-16 backdrop-blur-xl transition-all duration-300">
        ...
        <div className="flex-1 max-w-xl hidden md:block">
          <div className="relative group">
            ...
            <input 
              ...
              className="dashboard-search-input w-full h-10 pr-10 pl-4 rounded-full focus:ring-2 focus:ring-primary/20 transition-all text-sm outline-none"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 mr-auto">
          ...
          <div className="relative">
            <button 
              ...
              className="flex items-center gap-3 pl-2 pr-4 py-1.5 rounded-full hover:bg-secondary/70 border border-transparent hover:border-border transition-all cursor-pointer"
            >
              <div
