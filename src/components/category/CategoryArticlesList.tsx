  ...
  if (!articles.length) {
    return (
      <div id="content" className="rounded-[2rem] border border-slate-100 bg-white p-8 text-center shadow-sm sm:p-12" dir="rtl">
        ...
        <Link href="/search" className="mt-6 inline-flex h-12 items-center justify-center gap-2 rounded-2xl bg-blue-700 px-6 text-sm font-black text-white shadow-lg shadow-blue-700/20 transition hover:bg-blue-800">
