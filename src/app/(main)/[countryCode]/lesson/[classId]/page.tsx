...
export default async function ClassSubjectsPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] pb-16">
      ...
      <div id="content" className="container mx-auto px-4 mt-8">
        <SubjectsListWrapper adSettings={adSettings} hasContent={!!classInfo?.subjects?.length}>
          {/* Section Title */}
          <AnimatedSection delay={0.2}>
            <h2 className="text-2xl lg:text-3xl font-bold text-slate-900 mb-8 flex items-center gap-3">
